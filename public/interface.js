  ...
  var data = {
    ...
    games: {
      1: {
        ...
        //Частота обновления игровых полей
        cloneUpdateInterval: 50,

        // Смещение основного игрового поля
        mainAreaOffset: { x: 0, y: 0 },

        // Смещение левого игрового поля
        leftAreaOffset: { x: 266 - 532 + 0, y: 0 },

        // Смещение правого игрового поля
        rightAreaOffset: { x: 266 + 0, y: 0 },
